...
var store_path = path.join('/home/parikshit/saachi/Backup/fabric-samples/fabcar' , 'hfc-key-store');

var tx_id = null;
var chaincodeId = 'newfabcar';
...
app.use(serve_static(path.join('/home/parikshit/saachi/Backup/fabric-samples/fabcar', 'public')));
