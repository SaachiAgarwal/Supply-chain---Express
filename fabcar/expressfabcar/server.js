...
var store_path = path.join('/home/parikshit/saachi/fabric-samples/fabcar' , 'hfc-key-store');

var tx_id = null;
var chaincodeId = 'fabcarnew13';
...
app.use(serve_static(path.join('/home/parikshit/saachi/fabric-samples/fabcar', 'public')));
...
app.post('/createquery', (req, res) => {
	...
	tx_id = fabric_client.newTransactionID();
        var idGenerated = counter.toString();
	...
	var request = {		
                ...
                txId: tx_id,
                fcn: 'createCar',
                args: [idGenerated, req.body.make, req.body.model, req.body.colour, req.body.owner]
   ...
   Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	console.log("Assigning transaction_id: ", tx_id._transaction_id);
        ...
        var request = {
            ...
            txId: tx_id,
            fcn: 'changeCarOwner',
            args: [req.body.id,req.body.owner]
